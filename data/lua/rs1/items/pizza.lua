...
function opinv_plain_pizza(player)
...
function opinv_meat_pizza(player)
...
function opinv_half_meat_pizza(player)
...
function opinv_anchovie_pizza(player)
...
function opinv_half_anchovie_pizza(player)
